              ...
              <div className="flex flex-wrap justify-center gap-3">
                {categorySkills.map((skill) => (
                  <Badge 
                    key={skill.id} 
                    variant="secondary" 
                    className="bg-gradient-to-r from-slate-700 to-slate-800 text-white px-4 py-2 text-sm font-medium hover:from-purple-600 hover:to-pink-600 transition-all duration-300 cursor-default"
                  >
                    {skill.name}
                    {skill.level && (
